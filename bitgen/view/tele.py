...
class TeleViewer(DefaultViewer):
    ...
    def listen(self):
        ...
        handlers.append(ConversationHandler(
            ...
            states={'api_key':
                    ...
                    'api_secret':
                    [MessageHandler(Filters.text, self.api_secret, pass_chat_data=True)]},
    ...
    def api_key(self, bot, update, chat_data):
        ...
        update.message.reply_text("Please insert your api_secret")
        return 'api_secret'

    def api_secret(self, bot, update, chat_data):
        chat_data['secret'] = update.message.text
        OmniViewer().pers_data['coinbase-api'] = chat_data['api']
        OmniViewer().pers_data['coinbase-secret'] = chat_data['secret']
